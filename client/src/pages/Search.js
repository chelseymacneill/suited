                    ...
                    {loggedIn ? (
                        ...
                        <Col size="md-10 md-offset-1">
                            <Card className="p-3 mt-5 rounded-0">
                                ...
                                <h2 id="heading" className="text-center p-1 mb-0"><strong>Filters</strong> <h5 id="heading" className="p-1 mb-0">Results will be sorted by jobs with the most desired skills. All skills present in a job entry will be listed with their matching color at the bottom of the job card.</h5></h2>
